<p align="center">
  <img src="Assets/uNotch-logo.svg" width="112" height="112" alt="uNotch logo">
</p>
...
<p align="center">
  <a href="../../releases/latest/download/uNotch-1.0.0-arm64.dmg"><strong>Download for Apple silicon</strong></a>
  · macOS 14+
  · Native Swift
</p>
...
1. [Download the latest DMG](../../releases/latest/download/uNotch-1.0.0-arm64.dmg).
...
The current installer supports Apple silicon Macs running macOS 14 Sonoma or
newer.

## Use

- Move the pointer to the subtle cue at the top-left screen edge and hold for
  150 ms to reveal the HUD.
...
- Use the menu bar item to refresh everything, choose an edge, or quit.
...
[SECURITY.md](SECURITY.md) for trust boundaries and reporting.
...
Download `SHA256SUMS` from the same release, then run:
...
```text
Sources/uNotch/        AppKit windowing, SwiftUI UI, state, and CLI readers
Tests/uNotchTests/     Parser, state, hover geometry, and render checks
...
[GitHub's private vulnerability report](../../security/advisories/new) so it can
